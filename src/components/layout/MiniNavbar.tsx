...
const MiniNavbar = () => {
  ...
  return (
    <div className="bg-white h-9 flex items-center text-black text-xs z-50 shadow-sm border border-b-gray-950" role="navigation" aria-label="Contact Information">
