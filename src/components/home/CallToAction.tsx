        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              ...
              className="inline-flex items-center justify-center whitespace-nowrap rounded-[5px] text-sm font-medium bg-detailpros-pink hover:bg-opacity-90 text-white h-14 px-8"
            >
              Book Now
            </a>
            <Link to="/contact">
              <Button 
                variant="outline" 
                className="text-gray-900 border-gray-900 hover:bg-gray-900/10 h-14 px-8 rounded-[5px] w-full sm:w-auto"
              >
                Contact Us
              </Button>
            </Link>
